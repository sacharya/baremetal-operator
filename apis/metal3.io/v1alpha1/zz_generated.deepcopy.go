...
func (in *BareMetalHostSpec) DeepCopyInto(out *BareMetalHostSpec) {
	*out = *in
	...
	if in.LiveImage != nil {
		in, out := &in.LiveImage, &out.LiveImage
		*out = new(LiveImage)
		**out = **in
	}
	if in.UserData != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LiveImage) DeepCopyInto(out *LiveImage) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LiveImage.
func (in *LiveImage) DeepCopy() *LiveImage {
	if in == nil {
		return nil
	}
	out := new(LiveImage)
